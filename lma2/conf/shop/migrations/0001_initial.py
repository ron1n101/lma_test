    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image_main', models.ImageField(blank=True, upload_to='shop/images/home_gallery')),
                ('image_mid', models.ImageField(blank=True, upload_to='shop/images/home_gallery')),
                ('image_low', models.ImageField(blank=True, upload_to='shop/images/home_gallery')),
            ],
        ),
        migrations.CreateModel(
            name='Product',
